...
/**
 * Resolve which Stripe environment to use.
 * Prefers an explicit, validated value from the caller; otherwise falls back to
 * live when live keys exist, else sandbox.
 */
...
/** Verify a Stripe webhook signature without depending on the SDK's crypto path. */
