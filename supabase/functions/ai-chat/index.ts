...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are AutoVault AI, a friendly and knowledgeable car-finding assistant for AutoVault — a premium online car marketplace operating in the UK, US, Pakistan, and UAE.

Your capabilities:
- Help users find cars based on their budget, preferences, and needs
- Explain AutoVault features: verified listings, finance checks, HPI checks, MOT history
