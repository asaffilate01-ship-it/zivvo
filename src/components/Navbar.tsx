    ...
    <nav className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-xl">
      <div className="container mx-auto flex h-20 items-center justify-between px-4">
        ...
        <Link to="/" className="flex items-center gap-2" aria-label="Zivvo home">
          <img src={zivvoLogo} alt="Zivvo" decoding="async" fetchPriority="high" className="h-14 w-auto dark:invert dark:brightness-0 dark:contrast-200" />
        </Link>
            ...
            <SheetContent side="right" className="w-72 p-0">
              <SheetHeader className="border-b border-border p-4">
                <SheetTitle className="flex items-center gap-2">
                  <img src={zivvoLogo} alt="Zivvo" decoding="async" className="h-12 w-auto dark:invert dark:brightness-0 dark:contrast-200" />
                </SheetTitle>
              </SheetHeader>
