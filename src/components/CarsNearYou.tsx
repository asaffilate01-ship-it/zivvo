...
const cityCoords: Record<string, [number, number]> = {
  ...
  Dortmund: [51.5136, 7.4653], Essen: [51.4556, 7.0116], Bremen: [53.0793, 8.8017], Dresden: [51.0504, 13.7373],
  Hannover: [52.3759, 9.732], Nürnberg: [49.4521, 11.0767], Duisburg: [51.4344, 6.7623],
};
...
const reverseGeocodeGoogle = async (lat: number, lng: number): Promise<string> => {
  try {
    ...
    return data?.city || "Ihrer Umgebung";
  } catch {
    return "Ihrer Umgebung";
  }
};
...
const CarsNearYou = () => {
  ...
  useEffect(() => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      () => {
        setGeoStatus("denied");
        setLocationName("Deutschland");
        setUserCoords([51.1657, 10.4515]);
      },
