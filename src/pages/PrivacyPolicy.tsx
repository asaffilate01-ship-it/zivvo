...
const PrivacyPolicy = () => (
  <div className="min-h-screen bg-background">
    <SEOHead title="Privacy Policy — Zivvo" description="Learn how Zivvo collects, uses, and protects your personal data." />
    <Navbar />
    <div className="container mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-muted-foreground">
        <section>
          ...
          <p className="mt-2">Zivvo is an online marketplace for buying and selling vehicles. This policy explains how we collect, use, store, and protect your personal data in compliance with the UK GDPR and Data Protection Act 2018.</p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">To exercise any of these rights, use the settings in your Profile page or contact us at privacy@zivvo.co.uk.</p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">For privacy-related enquiries, email us at privacy@zivvo.co.uk.</p>
        </section>
      </div>
    </div>
    <Footer />
