...
export const countryConfigs: Record<CountryCode, CountryConfig> = {
  ...
  US: {
    ...
    individualPlan: { price: 25, priceId: "price_1TCRtiFFogsDQVs4eRrN2tRW", label: "per listing" },
    dealerPlans: [
      { name: "Starter", price: 59, priceId: "price_1TCRtjFFogsDQVs4xdZjexcX", maxListings: 15, features: ["Up to 15 active listings", "Basic analytics dashboard", "Marketplace presence", "Email support", "Standard listing placement"] },
      { name: "Professional", price: 129, priceId: "price_1TCRtkFFogsDQVs4MPwmVttm", maxListings: 50, features: ["Up to 50 active listings", "Full analytics & reports", "Custom dealer landing page", "Featured listing placements", "Priority support", "CARFAX integration", "Portal syndication (AutoTrader, eBay & more)"] },
      { name: "Enterprise", price: 249, priceId: "price_1TCRtlFFogsDQVs4n0vC6Szb", maxListings: 9999, features: ["Unlimited active listings", "White-label landing page", "API access & bulk import", "Dedicated account manager", "Advanced analytics", "Multi-location support", "Multi-portal syndication (6 portals)"] },
    ],
  ...
  PK: {
    ...
    individualPlan: { price: 2000, priceId: "price_1TCRtmFFogsDQVs47E1ZDNns", label: "per listing" },
    dealerPlans: [
      { name: "Starter", price: 9999, priceId: "price_1TCRtnFFogsDQVs4ewpE9ZlP", maxListings: 15, features: ["Up to 15 active listings", "Basic analytics dashboard", "Marketplace presence", "WhatsApp support", "Standard listing placement"] },
      { name: "Professional", price: 19999, priceId: "price_1TCRtpFFogsDQVs49uHcSfkW", maxListings: 50, features: ["Up to 50 active listings", "Full analytics & reports", "Custom dealer page", "Featured listing placements", "Priority support", "Portal syndication (AutoTrader, eBay & more)"] },
      { name: "Enterprise", price: 39999, priceId: "price_1TCRtqFFogsDQVs4FncdbY0G", maxListings: 9999, features: ["Unlimited active listings", "White-label dealer page", "Bulk import", "Dedicated account manager", "Advanced analytics", "Multi-city support", "Multi-portal syndication (6 portals)"] },
    ],
  ...
  AE: {
    ...
    individualPlan: { price: 75, priceId: "price_1TCRtqFFogsDQVs4huEtICrp", label: "per listing" },
    dealerPlans: [
      { name: "Starter", price: 199, priceId: "price_1TCRtrFFogsDQVs43A3zF0Av", maxListings: 15, features: ["Up to 15 active listings", "Basic analytics dashboard", "Marketplace presence", "WhatsApp support", "Standard listing placement"] },
      { name: "Professional", price: 399, priceId: "price_1TCRtsFFogsDQVs4oRhqMZIj", maxListings: 50, features: ["Up to 50 active listings", "Full analytics & reports", "Custom dealer page", "Featured listing placements", "Priority support", "Vehicle history integration", "Portal syndication (AutoTrader, eBay & more)"] },
      { name: "Enterprise", price: 799, priceId: "price_1TCRttFFogsDQVs4aaExww9R", maxListings: 9999, features: ["Unlimited active listings", "White-label dealer page", "API access & bulk import", "Dedicated account manager", "Advanced analytics", "Multi-emirate support", "Multi-portal syndication (6 portals)"] },
    ],
